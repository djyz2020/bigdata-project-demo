...
public class JavaKafkaProducerMessageSenderTest {
    ...
    public static void test2() throws InterruptedException {
        // 构建kafka生产者
        String topicName = "beifeng02";
        String brokerList = "master.bigdata.com:9092,master.bigdata.com:9093,master.bigdata.com:9094,master.bigdata.com:9095";
        String serilizerClassName = "kafka.serializer.StringEncoder";
        String partitionerClassName = "com.bigdata.kafka.producer.JavaKafkaProducerePartitioner";
